...
<body>
    ...
    ?>
			...
			<tr>
				...
				<td><input type="radio" name="sex" value="1"><?php echo $lang['AWEMU.MALE'];?> <input
					type="radio" name="sex" value="2"><?php echo $lang['AWEMU.FEMALE'];?></td>
			</tr>
			<tr>
		...
		<p>
			<input type="submit" name="submit"
				value="<?php echo $lang['AWEMU.SEND'];?>">
		</p>
	</form>
</body>
</html>
