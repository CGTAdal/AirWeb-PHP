...
<table border="0" bgcolor="">
  <tr>
    <td>マーチャントID</td>
    <td>
      <input type="text" size="40" name="merchantID" value="<?= $form->getFormValue('merchantID') ?>">
    </td>
  </tr>
  <tr>
    <td>オーダーID</td>
    <td>
      <input type="text" size="40" name="orderID" value="<?= $form->getFormValue('orderID') ?>">
    </td>
  </tr>
  <tr>
    <td>決済種別</td>
    <td>
      <input type="text" size="40" name="settlementmethod" value="<?= $form->getFormValue('settlementmethod') ?>">
    </td>
  </tr>
  <tr>
    <td>金額</td>
    <td>
      <input type="text" size="40" name="amount" value="<?= $form->getFormValue('amount') ?>">
    </td>
  </tr>
</table>
<br>
<input type="submit" name="submit" value="ハッシュ計算">
</form>
<p>
Hash:[<?= $hashvalue ?>]<br>
</p>
