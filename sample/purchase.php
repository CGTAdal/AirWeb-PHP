...
<body>
	...
	<table class="cart">
		...
		<tr>
			<td colspan="4" class="sum"><?php echo $lang['PURCHASE.SHIPPING_AMOUNT'];?><?php echo $lang['PURCHASE.COLON'];?> 500 <?php echo $lang['PURCHASE.YEN'];?></td>
		</tr>
		<tr>
			<td colspan="4" class="sum"><?php echo $lang['PURCHASE.TOTAL'];?><?php echo $lang['PURCHASE.COLON'];?> 1,900 <?php echo $lang['PURCHASE.YEN'];?></td>
		</tr>
	</table>
	<br />
	<table class="noline">
		<tr>
			<td><a href="./default/entry.php"><?php echo $lang['PURCHASE.NO_SPECIFIED'];?></a>&nbsp;</td>
			<td><a href="./card/entry_card.php"><?php echo $lang['PURCHASE.CARD'];?></a>&nbsp;</td>
			<td><a href="./cvs/entry_cvs.php"><?php echo $lang['PURCHASE.CVS'];?></a>&nbsp;</td>
		</tr>
	</table>
</body>
</html>
