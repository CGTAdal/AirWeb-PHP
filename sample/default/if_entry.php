...
if (!isset($form)) {
    ...
    // セッションにパラメータが登録されている
    if (isset($_SESSION['PurchaseForm'])) {
        $log_entry->debug("他画面からの遷移：Formをセッションから取得");
        $form->setRequestArray($_SESSION['PurchaseForm']);
    } else {
...
<body>
	...
	<div class="contents">
		...
		<form method="post" action="ConfirmAction.php" name="PurchaseForm"
