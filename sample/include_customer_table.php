...
<table class="customer">
	...
	<tr>
		...
		<td class="value"><input type="text" size="5" name="telephoneNo1"
			...
			value="<?= $form->getFormValue('telephoneNo3') ?>" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="value"><input type="radio" name="sex" value="1"
			<?= $form->getFormChecked('sex', "1") ?>><?php echo $lang['ENTRY.MALE'];?> <input
			type="radio" name="sex" value="2"
			<?= $form->getFormChecked('sex', "2") ?>><?php echo $lang['ENTRY.FEMALE'];?> <input
			type="hidden" name="sex" value="" /></td>
	</tr>
</table>
