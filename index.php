...
<body>
	<div style="margin: 1em auto; padding: 0; text-align: center;">
		...
		<br /> <br /> <br> <br> <a href="./test/AirWebReponseEmu.php"><?php echo $lang['INDEX.AIRWEB_RESPONSE'];?></a><br />
		<br /> <br /> <a href="./test/CustomerReturn.php"><?php echo $lang['INDEX.BROWSER_RETURN'];?></a><br />
		<br /> <a href="./index.php?lang=ja"><?php echo $lang['INDEX.JAPANESE'];?></a>&nbsp;
