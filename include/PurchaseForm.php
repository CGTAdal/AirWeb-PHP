 ...
 * 入力フォームクラス
 */
class PurchaseForm extends ActionForm {
     ...
     * 支払期限の設定
     *
     * @param string $timelimitOfPayment
     *            支払期限
     */
     ...
     * 決済完了後戻りURLの設定
     *
     * @param string $finishPaymentReturnUrl
     *            決済完了後戻りURL
     */
     ...
     * 決済結果の設定
     *
     * @param string $settlementComplete
     *            決済結果
     */
    ...
    public function validate(){
        ...
        if ($this->namemap == null || $this->getNamelistSize() == 0) {
            if (($this->idmap != null && $this->getIdlistSize() > 0) || ($this->janCodemap != null && $this->getJanCodelistSize() > 0) || ($this->nummap != null && $this->getNumlistSize() > 0) || ($this->unitmap != null && $this->getUnitlistSize() > 0)) {
            ...
            if ($this->nummap == null || $this->getNumlistSize() != $commoditySize || $this->unitmap == null || $this->getUnitlistSize() != $commoditySize || ($this->idmap != null && $this->getIdlistSize() != $commoditySize) || ($this->janCodemap != null && $this->getJanCodelistSize() != $commoditySize)) {
