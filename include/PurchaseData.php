...
class PurchaseData {
     ...
     * 決済結果通知先URLの設定
     *
     * @param string $finishPaymentAccessUrl
     *            決済結果通知先URL
     */
     ...
     * ダミー取引フラグの取得
     *
     * @return string ダミー取引フラグ
     */
    public function getDummyPaymentFlag(){
        return $this->dummyPaymentFlag;
    }
    
    /**
     * ダミー取引フラグの設定
     *
     * @param string $dummyPaymentFlag
     *            ダミー取引フラグ
     */
    public function setDummyPaymentFlag($dummyPaymentFlag){
